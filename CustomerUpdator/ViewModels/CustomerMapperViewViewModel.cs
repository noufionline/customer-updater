...
{
    public class CustomerMapperViewViewModel : BindableBase
    {
    ...
    {
        [OdooFieldName("partner_id")] public int PartnerId { get; set; }

        [OdooFieldName("partner_id", index: 1)]
        public string PartnerName { get; set; }

        [OdooFieldName("project_id")] public int ProjectId { get; set; }

        [OdooFieldName("project_id", index: 1)]
        public string ProjectName { get; set; }

        [OdooFieldName("sun_account_no")] public string SunAccountCode { get; set; }

        //	[OdooFieldName("old_sun_account_no")]
        //	public string OldSunAccountCode { get; set; }

        [OdooFieldName("sun_db")] public string SunDb { get; set; }
    ...
    {
        [OdooFieldName("id")] public int Id { get; set; }
        [OdooFieldName("partner_id")] public int PartnerId { get; set; }
        [OdooFieldName("name")] public string Name { get; set; }
    }
    ...
    public interface IOdooObjectRpc : IXmlRpcProxy
    {
        ...
        [XmlRpcMethod("execute")]
        bool Write(string database, int userId, string password, string model, string method, int[] ids,
            XmlRpcStruct fieldValues);

        [XmlRpcMethod("execute")]
        bool Unlink(string database, int userId, string password, string model, string method, int[] ids);

        [XmlRpcMethod("execute")]
        object[] Read(string database, int userId, string password, string model, string method, int[] ids,
            object[] fields);
        ...
        [XmlRpcMethod("execute")]
        ValidationInfo ValidatePartner(string dbName, int userId, string pwd, string model, string method,
            string sunAccountCode, string sunDb);
    ...
    {
        [XmlRpcMember("ACCNT_CODE")] public string AccountCode { get; set; }
        [XmlRpcMember("ACCNT_NAME")] public string AccountName { get; set; }
    ...
    public class OdooApi
    {
        ...
        {
            return _objectRpc.Create(_credentials.Database, _credentials.UserId, _credentials.Password, model, "create",
                fieldValues);
        }

        public int[] Search(string model, object[] filter)
        {
            return _objectRpc.Search(_credentials.Database, _credentials.UserId, _credentials.Password, model, "search",
                filter);
        }

        public object[] Read(string model, int[] ids, string[] fields)
        {
            return _objectRpc.Read(_credentials.Database, _credentials.UserId, _credentials.Password, model, "read",
                ids, fields);
        }

        public bool Write(string model, int[] ids, XmlRpcStruct fieldValues)
        {
            return _objectRpc.Write(_credentials.Database, _credentials.UserId, _credentials.Password, model, "write",
                ids, fieldValues);
        }

        public bool Remove(string model, int[] ids)
        {
            return _objectRpc.Unlink(_credentials.Database, _credentials.UserId, _credentials.Password, model, "unlink",
                ids);
        }

        public bool Execute_Workflow(string model, string action, int id)
        {
            return _objectRpc.ExecuteWorkflow(_credentials.Database, _credentials.UserId, _credentials.Password, model,
                action, id);
        }
    ...
    {
        // Fields
        [XmlRpcMember("allow_transaction")] public bool AllowTransaction;
        [XmlRpcMember("partner_id")] public int CustomerId;
        [XmlRpcMember("partner_name")] public string CustomerName;
        [XmlRpcMember("description")] public string Description;
        [XmlRpcMember("invalid_sun_code")] public bool InvalidSunAccountCode;
        [XmlRpcMember("is_project")] public bool IsProject;
        [XmlRpcMember("project_id")] public int ProjectId;
        [XmlRpcMember("sun_account_name")] public string ProjectName;
        [XmlRpcMember("rating_category")] public string RatingCategory;

        [XmlRpcMember("trn")] public string TaxRegistrationNo { get; set; }
    ...
    {
        [XmlRpcMember("TAX_CODE")] public string TaxRegistationNo { get; set; }
        [XmlRpcMember("ACCNT_NAME")] public string AccountName { get; set; }
